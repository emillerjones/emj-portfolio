...
const MAJOR_PROJECTS = [
  ...
  },
  {
    ...
    type: "Nonprofit community platform",
    status: "Active development · 2026",
    role: "Full-stack developer and product designer",
    problem: "A recovery nonprofit needed a safer, more intentional home for peer support than a collection of disconnected public channels.",
    built: "A public site plus protected community spaces: registration and admission, role-based access, forums, nested replies, supportive reactions, following, unread state, notifications, private messaging, moderation, analytics, and a live Lounge.",
    outcome: "A working React, Express, and PostgreSQL platform designed mobile-first around trust, clarity, and community safety.",
    tags: ["React", "Express", "PostgreSQL", "Authentication", "Product Design"],
    artifact: "recovery",
    links: [
