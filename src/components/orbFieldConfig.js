...
export const GROUP_DEFS = [
  { key: "ceramic", count: 480, litRatio: 1 / 54, color: "#9b3d46", roughness: 0.8, metalness: 0.05, lit: "#ff4d5a", power: 10, reach: 15, hueJitter: 0.07, satJitter: 0.25, lightJitter: 0.18 },
  { key: "slate", count: 480, litRatio: 1 / 68, color: "#294f88", roughness: 0.75, metalness: 0.08, lit: "#4d9dff", power: 10, reach: 15, hueJitter: 0.09, satJitter: 0.28, lightJitter: 0.18 },
  { key: "brass", count: 420, litRatio: 1 / 47, color: "#b99a38", roughness: 0.34, metalness: 0.58, clearcoat: 0.35, lit: "#ffe04d", power: 11.5, reach: 16, hueJitter: 0.05, satJitter: 0.2, lightJitter: 0.14 },
  { key: "glass-shiny", count: 420, litRatio: 1 / 61, color: "#653c82", roughness: 0.2, metalness: 0.1, clearcoat: 0.55, clearcoatRoughness: 0.2, lit: "#c56cff", power: 11.5, reach: 16, hueJitter: 0.1, satJitter: 0.3, lightJitter: 0.16 },
  ...
  { key: "crystal", count: 360, litRatio: 1 / 65, color: "#245b4a", roughness: 0.16, metalness: 0, transmission: 0.6, thickness: 0.4, ior: 1.5, attenuationColor: "#75e7b0", attenuationDistance: 0.6, lit: "#55ed9a", power: 13, reach: 17, hueJitter: 0.12, satJitter: 0.3, lightJitter: 0.16 },
];
